...
<head>
    ...
    <title>Lupa Password - Lentera</title>
...
<body class="pattern-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <h2 class="text-xl font-bold text-gray-800 mb-2 text-center">Lupa Password?</h2>
            <p class="text-gray-500 text-center mb-6 text-sm">Masukkan email Anda untuk menerima kode OTP</p>
